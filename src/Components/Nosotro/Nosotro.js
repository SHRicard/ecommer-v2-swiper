              ...
              >
                <div className="accordion-body  ">
                  ...
                  <small className="text-Anton text-black">
                    <br />
                    No ,los productos son réplicas importadas de excelente
                    cálida cuenta con capellá reforzada en algunos casos son
                    originales. Para verificar si el producto elegido es
                    original o replicada, puede ingresar al detalle del producto
                    y verificar la procedencia de dicho producto. Corregido con
                  </small>
                  <br />
                  <br />
                  <small className="text-Anton text-muted">
                  ...
                  <small className="text-Anton text-black">
                    ...
                    compras simultáneas, vamos a realizar la devolución del
                    monto pagado por el producto sin stock, al mismo medio de
                    pago utilizado para la compra. Puede suceder que si
                    compraste muchos productos y no podemos entregar la
                    totalidad de tu pedido, lo despacharemos con los productos
                    disponibles y te reembolsaremos el valor por los ítems
                    indisponibles al mismo medio de pago. Tené en cuenta que
                    como realizamos reposición constante de productos, el
                    artículo que hayas seleccionado podría volver a tener stock
                    a la brevedad.
                  </small>
                  <br />
                  <br />
              ...
              >
                <div className="accordion-body text-Anton text-muted">
                  ...
                  <small className="text-Anton text-black">
                    ...
                    afectado el pago de dicho producto o envió los comprobantes
                    de dicho pago
                  </small>
                </div>
              </div>
              ...
              >
                <div className="accordion-body text-Anton text-muted">
                  ...
                  <small className="text-Anton text-black">
                    ...
                    producto en otro talle tendrá la opc de cambiar de producto
                  ...
                  <small className="text-Anton text-black">
                    ...
                    procesada, o bien, cuando la devolución de tu producto
                    apruebe el control de calidad, recibirás de forma automática
                    el reembolso de tu dinero, recordá que los tiempos en ver
